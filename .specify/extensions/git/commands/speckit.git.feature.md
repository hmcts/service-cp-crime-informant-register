...
This project's local convention is to prefix feature branches with the Jira ticket id (e.g. `DD-41656-extended-test-disqualification`) instead of a sequential `001-...` number. The script supports this via:
